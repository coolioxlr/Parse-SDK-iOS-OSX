...
/**
 ...
 @return The task that encapsulates the work being done.
 */
- (BFTask<NSNumber *> *)saveEventually PF_TV_UNAVAILABLE;
...
/**
 ...
 It should have the following argument signature: `^(BOOL succeeded, NSError *error)`.
 */
- (void)saveEventually:(nullable PFBooleanResultBlock)callback PF_TV_UNAVAILABLE;
...
/**
 ...
 @return The task that encapsulates the work being done.
 */
- (BFTask<NSNumber *> *)deleteEventually PF_TV_UNAVAILABLE;
